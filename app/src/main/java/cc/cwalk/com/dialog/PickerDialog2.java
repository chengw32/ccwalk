 ...
 *图片选择对话框
 */
public class PickerDialog2 extends Dialog implements View.OnClickListener {
    private Activity activity;
    private PickCallBack mPickCallBack ;



    public PickerDialog2(Activity activity, PickCallBack callBack) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.image_picker_dialog_layout2);
        initView();
    }
