...
public class UserInfoActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        mPersonalDataName.setText(DataUtils.getInstance().getUserById(SPUtils.getId()).name);
//        mEtPhone.setText(DataUtils.getInstance().getUserById(SPUtils.getId()).pho);
        if (DataUtils.getInstance().getUserById(SPUtils.getId()).sex == 1){
