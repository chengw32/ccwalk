...
public class MyHomePagerActivity extends BaseListActivity {
    ...
    protected BaseRecyclerAdapter getAdapter() {
        return new BaseRecyclerAdapter<DataBean.VideosBean>() {
            ...
            public Context getContext() {
                return MyHomePagerActivity.this;
            }
...
//        else DetailImagesActivity.startActivity(xContext,bean);
    ...
    protected void initView() {
        ...
        headView = LayoutInflater.from(MyHomePagerActivity.this)
...
//        tvAccount.setText(bean.getName());
        ...
        iv_sex.setImageResource(SPUtils.getSex() == 1 ? R.mipmap.ic_gender_male : R.mipmap.ic_gender_female);
    ...
    public static void startActivity(Context context, DataBean bean) {
        ...
        Intent intent = new Intent(context, MyHomePagerActivity.class);
